        ...
        return (
            <div>
                ...
                <div id="mySidenav" className="sidenav">
                    ...
                    <div><a href="daily_habit.html" className="mobileMenuText">How to make meditation a daily habit </a><i onClick ={this.subMenu1} className="fas fa-angle-down"style={{fontSize: '28px', display: 'inline'}}></i></div>
                    ...
                    <div><a href="#" className="mobileMenuText">Get started </a><i onClick ={this.subMenu2} className="fas fa-angle-down"style={{fontSize: '28px', display: 'inline'}}></i></div>
                    ...
                    <div><a href="#" className="mobileMenuText">Meditation essentials </a><i onClick ={this.subMenu3} className="fas fa-angle-down"style={{fontSize: '28px', display: 'inline'}}></i></div>
                    ...
                    <div><a href="#" className="mobileMenuText">Reviews </a><i onClick ={this.subMenu4} className="fas fa-angle-down"style={{fontSize: '28px', display: 'inline'}}></i></div>
